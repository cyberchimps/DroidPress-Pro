...
<div id="box_container">
		<?php if ( !function_exists('dynamic_sidebar') || !dynamic_sidebar("Box Left") ) : ?>
			<div class="box1">
				<h2 class="box-widget-title">DroidPress Pro Slider</h2>
					<img src="<?php echo $root ; ?>/images/icons/slidericon.png" height="100" alt="slider" class="aligncenter" />
					<p>The DroidPress Pro Slider includes auto-image resizing, new transitions, thumbnails, custom categories, improved captions, and the ability to have a slider on every page.</p>
			</div><!--end box1-->
			<?php endif; ?>
			...
			<div class="box2">
				<h2 class="box-widget-title">Advanced Design</h2>
					...
					<p>With <a href="http://cyberchimps.com/droidpress/">DroidPress Pro</a> we’ve done the design work for you, all you need to do is pick your colors, select your settings, and add your content.</p>
			</div><!--end box2-->
			<?php endif; ?>

...
array( "name" => "Choose Menu Color",
	"desc" => "(Default is 3B5A7B)",
...
array( "name" => "Site Title Color",  
    "desc" => "Use the color picker to select the site title color (Default is FFFFFF)",  
    "id" => $shortname."_sitetitle_color",  
      "type" => "color1",  
    "std" => "false"),
    
array( "name" => "Link Color",  
    "desc" => "Use the color picker to select the site link color (Default is 3B5A7B)",  
    "id" => $shortname."_link_color",  
      "type" => "color2",  
    "std" => "false"),

array( "name" => "Post Title Color",  
    "desc" => "Use the color picker to select the post title color (Default is 000000)",  
...
array( "name" => "Hide the Featured Posts Section",  
    "desc" => "Check this box to hide the Featured Posts Section on your blog page.",  
    "id" => $shortname."_hide_featured_posts",  
	"type" => "checkbox",  
    "std" => "false"),
...
array( "name" => "Show the Slider",  
    "desc" => "Check this box to show the Slider on your blog page.",  
